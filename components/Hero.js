export class Hero {
  constructor(props = {}) {
    this.props = {
      ...
      description: 'We engineer client-centered SaaS applications that are built to last. Future-extensible solutions with clean code, comprehensive launch support, and ongoing maintenance you can trust.',
