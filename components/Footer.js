export class Footer {
  constructor(props = {}) {
    this.props = {
      brandName: 'WebSolCr',
      description: 'Expert SaaS application engineering with client-centered solutions and future-extensible architecture.',
      socialLinks: [
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400">
              &copy; ${this.props.copyright} ${this.props.brandName}. All rights reserved.
            </p>
            <div class="flex space-x-6 mt-4 md:mt-0">
              ${this.props.legalLinks.map(link => `
                <a href="${link.href}" class="text-gray-400 hover:text-white transition-colors">
                  ${link.label}
                </a>
              `).join('')}
